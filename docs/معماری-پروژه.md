...
│   └── ThemeToggle.tsx           # دکمه تغییر تم (در Dropdown کاربر)
...
در نوار تب‌های `App.tsx`، یک دکمه رفرش (`RefreshCw`) در انتهای تب‌ها قرار دارد که با کلیک، `refreshKey` را افزایش داده و باعث ریمونت کامپوننت تب فعال می‌شود.
