        ...
        <AnimatePresence>
            {toast && (
                <motion.div
                    ...
                    className={`fixed top-4 left-4 right-4 sm:left-auto sm:right-4 z-[9999] p-4 rounded-2xl shadow-2xl border flex items-center gap-3 max-w-md ${toast.type === 'success'
