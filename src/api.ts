...
class ApiService {
   ...
   */
  async getAllRegistrations(params?: { course_id?: number; status?: string; page?: number; per_page?: number; payment_method?: string; search?: string }): Promise<{ data: CourseRegistration[]; meta: any }> {
    const query = new URLSearchParams();
